...
; Johto hidden items
	...
	const EVENT_ROUTE_34_HIDDEN_THUNDERSTONE
...
; Johto itemballs
	...
	const EVENT_VIOLET_CITY_TM_THUNDER_WAVE
	...
	const EVENT_TEAM_ROCKET_BASE_B3F_TM_ROCK_SLIDE
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_STONE_EDGE
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_SNORE
	const EVENT_VICTORY_ROAD_ULTRA_BALL
...
; New to Crystal
	...
	const EVENT_PICKED_UP_MIRACLEBERRY_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_PSNCUREBERRY_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_TWISTEDSPOON_FROM_KABUTO_ITEM_ROOM
	const EVENT_PICKED_UP_BRIGHTPOWDER_FROM_KABUTO_ITEM_ROOM
	...
	const EVENT_PICKED_UP_LEFTOVERS_FROM_AERODACTYL_ITEM_ROOM
	...
	const EVENT_MOUNT_MORTAR_1F_INSIDE_TM_EARTHQUAKE
