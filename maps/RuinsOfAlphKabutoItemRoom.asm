...
RuinsOfAlphKabutoItemRoomMiracleBerry:
	itemball MIRACLEBERRY

RuinsOfAlphKabutoItemRoomPsncureberry:
	itemball PSNCUREBERRY

RuinsOfAlphKabutoItemRoomTwistedspoon:
	itemball TWISTEDSPOON

RuinsOfAlphKabutoItemRoomBrightPowder:
...
RuinsOfAlphKabutoItemRoom_MapEvents:
	...
	def_object_events
	object_event  2,  6, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphKabutoItemRoomMiracleBerry, EVENT_PICKED_UP_MIRACLEBERRY_FROM_KABUTO_ITEM_ROOM
	...
	object_event  2,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphKabutoItemRoomTwistedspoon, EVENT_PICKED_UP_TWISTEDSPOON_FROM_KABUTO_ITEM_ROOM
	object_event  5,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphKabutoItemRoomBrightPowder, EVENT_PICKED_UP_BRIGHTPOWDER_FROM_KABUTO_ITEM_ROOM
