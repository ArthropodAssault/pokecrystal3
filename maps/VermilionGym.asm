...
LtSurgeIntroText:
	...
	para "You've taken down"
	line "some strong trainers."

	para "Kanto gym leaders"
	line "used to have a bad,"
	cont "reputation."

	para "But, we've grown"
	line "a lot."

	para "Our region isn't"
	line "as easy as it used"
	cont "to be."	

	para "You better be ready."
	done
