...
DarkCaveBlackthornEntranceTMStoneEdge:
...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event 21, 24, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, DarkCaveBlackthornEntranceTMStoneEdge, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_STONE_EDGE
