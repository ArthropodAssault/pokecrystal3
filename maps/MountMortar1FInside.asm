...
MountMortar1FInsideTMEarthquake:
...
MountMortar1FInside_MapEvents:
	...
	object_event 17, 17, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, MountMortar1FInsideTMEarthquake, EVENT_MOUNT_MORTAR_1F_INSIDE_TM_EARTHQUAKE
