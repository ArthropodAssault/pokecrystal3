...
RuinsOfAlphAerodactylItemRoomLeftovers:
	itemball LEFTOVERS
...
RuinsOfAlphAerodactylItemRoom_MapEvents:
	...
	object_event  2,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphAerodactylItemRoomKingsRock, EVENT_PICKED_UP_KINGS_ROCK_FROM_AERODACTYL_ITEM_ROOM
	object_event  5,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, RuinsOfAlphAerodactylItemRoomLeftovers, EVENT_PICKED_UP_LEFTOVERS_FROM_AERODACTYL_ITEM_ROOM
