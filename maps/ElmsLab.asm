...
ElmCheckEverstone:
	...
	checkevent EVENT_SHOWED_EEVEE_TO_ELM
	iftrue ElmGiveEverstoneScript
	checkevent EVENT_TOLD_ELM_ABOUT_EEVEE_OVER_THE_PHONE
	iffalse ElmCheckEeveeEgg
	setval EEVEE
	special FindPartyMonThatSpeciesYourTrainerID
	iftrue ShowElmEeveeScript
	setval EEVEE
	special FindPartyMonThatSpeciesYourTrainerID
	iftrue ShowElmEeveeScript
...
ElmCheckEeveeEgg:
	checkevent EVENT_GOT_EEVEE_EGG_FROM_ELMS_AIDE
	iffalse ElmCheckGotEggAgain
	checkevent EVENT_EEVEE_HATCHED
	iftrue ElmEggHatchedScript
ElmCheckGotEggAgain:
	checkevent EVENT_GOT_EEVEE_EGG_FROM_ELMS_AIDE ; why are we checking it again?
...
ShowElmEeveeScript:
	writetext ShowElmEeveeText1
	waitbutton
	closetext
	showemote EMOTE_SHOCK, ELMSLAB_ELM, 15
	setevent EVENT_SHOWED_EEVEE_TO_ELM
	opentext
	writetext ShowElmEeveeText2
	promptbutton
	writetext ShowElmEeveeText3
	promptbutton
