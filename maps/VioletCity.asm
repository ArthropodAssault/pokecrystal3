...
VioletCity_MapEvents:
	...
	object_event  4,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, VioletCityTMTHUNDERWAVE, EVENT_VIOLET_CITY_TM_THUNDER_WAVE
